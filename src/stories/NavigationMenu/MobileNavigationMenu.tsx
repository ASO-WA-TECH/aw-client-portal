...
const MobileNavigationMenu = ({ setIsOpen }: MobileNavigationMenuProps) => {
  return (
    <div className="navigation-menu__mobile" data-testid="mobile-menu">
      {/* Added type="button" to satisfy the ButtonProps interface */}
      <Button
        type="button"
        customStyle="navigation-menu__mobile__close-button"
      ...
      <ul className="navigation-menu__mobile__links">
        {routes.map((route) => {
          ...
          return (
            <li key={href} className="navigation-menu__mobile__links__item">
              <a
                href={href}
